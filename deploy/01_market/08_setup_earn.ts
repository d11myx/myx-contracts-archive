...
const func: DeployFunction = async function ({ getNamedAccounts, deployments, ...hre }: HardhatRuntimeEnvironment) {
    ...
    //     ...COMMON_DEPLOY_PARAMS,
    // });
    // const myx = (await hre.ethers.getContractAt(myxArtifact.abi, myxArtifact.address)) as MYX;
    //
    // // raMYX
    ...
    //     ...COMMON_DEPLOY_PARAMS,
    // });
    // const raMYX = (await hre.ethers.getContractAt(raMYXArtifact.abi, raMYXArtifact.address)) as RaMYX;
    //
    // // stMYX
    ...
    //     ...COMMON_DEPLOY_PARAMS,
    // });
    // const stMYX = (await hre.ethers.getContractAt(stMYXArtifact.abi, stMYXArtifact.address)) as StMYX;
    //
    // // MYXVester
    ...
    //     args: [[myx.address, raMYX.address], stMYX.address, usdt.address, positionManager.address],
    //     ...COMMON_DEPLOY_PARAMS,
    // });
    ...
    //     ...COMMON_DEPLOY_PARAMS,
    // });
    // const convertor = (await hre.ethers.getContractAt(convertorArtifact.abi, convertorArtifact.address)) as Convertor;
    //
