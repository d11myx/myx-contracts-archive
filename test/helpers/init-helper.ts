...
export async function deployTrading(deployer: SignerWithAddress) {
  ...
  await tradingUtils.setContract(
    testEnv.pairInfo.address,
    testEnv.pairVault.address,
    tradingVault.address,
    tradingRouter.address,
    testEnv.vaultPriceFeed.address,
  );
  ...
  await tradingRouter.initialize(
    testEnv.pairInfo.address,
    testEnv.pairVault.address,
    tradingVault.address,
    tradingUtils.address,
  ...
  await executeRouter.initialize(
    ...
    tradingVault.address,
    tradingRouter.address,
    testEnv.fastPriceFeed.address,
    tradingUtils.address,
    60,
  );

  await testEnv.pairVault.setHandler(tradingVault.address, true);
